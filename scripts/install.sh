...
function saveProfile(){
	...
	cp -fR "$THEMEDIRECTORY/thunderbird-gnome-theme" "$PWD/" || { echo "FAIL, couldn't copy to $PWD/chrome, please check if there's something named 'chrome', that is not a dir."; exit 1; }
